    ...
    try{
      ...
      if(!SRK_TAXONOMY.some(d=>d.code==='S11')){
        SRK_TAXONOMY.push({
          ...
          core:'孩子在进食、饮水、如厕需求和基本个人自理上，能做到多少？',axis:'AGE',activeBands:['3-4'],
      ...
      installed=true;
      window.__LOVEGO_V46_SRK_RECONCILIATION__={installed:true,source:'PTM Track B B0 + Golden Rubric FINAL',changes:['SRK S11 Self-Care age 3-4','age applicability filter','remove local logout','visible version v46']};
      return true;
