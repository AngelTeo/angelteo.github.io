...
const APP_VERSION=44,KEY='lovego';
...
(()=>{['LoveGo_v40_dashboard.js','LoveGo_v41_student_override.js','LoveGo_v42_reporting_context.js','LoveGo_v43_ptmgo_gate.js','LoveGo_v44_work_queue.js'].forEach(src=>{const s=document.createElement('script');s.src=src;s.async=false;document.head.appendChild(s);});})();